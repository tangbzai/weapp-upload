...
function lastCommit() {
    try {
        var logStr = require$$1.execSync("git log -1").toString();
        var logBranchStr = require$$1.execSync("git branch -v").toString();
        return {
...
function getConfig() {
    if (!fs$1.existsSync(require$$2.join(process.cwd(), CONFIG_PATH))) {
        console.log("wx-upload-config.json不存在");
        return {};
    }
    var configStr = fs$1.readFileSync(require$$2.join(process.cwd(), CONFIG_PATH), {
        encoding: "utf8"
    });
    try {
...
function uploadAction() {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var config, version, appidStr, appid, commitInfo, descText;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 4:
                    ...
                    descText = formatDescription(config.description, __assign(__assign({}, commitInfo), { version: config.version }));
...
upload.action(function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, uploadAction()];
            case 1:
                _a.sent();
                require$$4.exit();
                return [2 /*return*/];
